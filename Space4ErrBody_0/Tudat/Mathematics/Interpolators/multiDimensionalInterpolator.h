...
protected:
            ...
            DependentVariableType& dependentVariable )
    {
        ...
        //std::cout << "currentDimension:" << currentDimension << std::endl;
        //std::cout << "useValue:" << useValue << std::endl;
        //std::cout << "currentIndependentVariable:" << currentIndependentVariable << std::endl;
        //std::cout << "dependentVariable:" << dependentVariable << std::endl;
