...
#include "../tudatApplications/Space4ErrBody.git/Space4ErrBody_0/Space4ErrBody_Executables_and_Headers/bislipVariables.h"
//#include "../tudatApplications/Space4ErrBody.git/Space4ErrBody_0/Space4ErrBody_Executables_and_Headers/updateGuidance.h"
        ...
        std::map< propagators::IntegratedStateType, orbit_determination::StateDerivativePartialsMap >( ) )
{
    ...
    case body_fixed_thrust_vector:
    {
        ...
        std::shared_ptr< system_models::VehicleSystems > vehicleSystems = bodyMap.at( bodyWithProperty )->getVehicleSystems( );

        variableFunction = std::bind( &bislip::variables::computeBodyFixedThrustVector, flightConditions, vehicleSystems );
        ...
        std::map< propagators::IntegratedStateType, orbit_determination::StateDerivativePartialsMap >( ) )
{
    ...
    else
    {
        ...
        case normalized_specific_energy:
        {
            ...
            std::function< double( ) > thirdInput =
                    std::bind( &system_models::VehicleSystems::getE_max, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
        ...
        case throttle_setting:
        {
            ...
            std::function< double( const double, const std::string, const std::shared_ptr< tudat::system_models::VehicleSystems >, const double, const double, const double ) > functionToEvaluate =
                    std::bind( &bislip::variables::evaluateGuidanceInterpolator, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4,std::placeholders::_5, std::placeholders::_6 );


            //std::cout << "Throttle setting for dependent variable" << std::endl;



            //   std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >() > interpolator =
            //       std::bind( &system_models::VehicleSystems::getThrustElevationAngleInterpolator, bodyMap.at( bodyWithProperty )->getVehicleSystems() );


            //std::function< bislip::variables::GuidanceParameter( ) > parameter =
            //     std::bind( &bislip::variables::GuidanceParameter(),bislip::variables::GuidanceParameter::ThrottleSetting  );


            //      std::function< std::string( const std::string ) > parameter =
            //             std::bind( &bislip::variables::passGuidanceParameter, throttle );



            //    std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >( const double, const std::string, const std::shared_ptr< tudat::system_models::VehicleSystems > ) > function_get_interpolator =
            //           std::bind( &system_models::VehicleSystems::getGuidanceInterpolator, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);


            //! Retrieve function for vehicle systems.
            // std::function< std::shared_ptr< tudat::system_models::VehicleSystems >( ) > vehicleSystems = std::bind( &simulation_setup::Body::getVehicleSystems, bodyMap.at( bodyWithProperty ) );


            //! Retrieve function for interpolator.
            //std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >( const double, const std::string ,const std::shared_ptr< tudat::system_models::VehicleSystems >) > interpolator =
            //        std::bind( &bislip::variables::chooseGuidanceInterpolator, flightpathangle, parameter, vehicleSystems );

            //std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >( const double, const std::string, const std::shared_ptr< tudat::system_models::VehicleSystems > ) > function_choose_interpolator =
            //        std::bind( &system_models::VehicleSystems::getGuidanceInterpolator, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);


            //  std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >( ) > get_interpolator =
            // std::bind( &system_models::VehicleSystems::getGuidanceInterpolator, flightpathangle, throttle, vehicleSystems );


            //get_interpolator = std::bind( &evaluateTrivariateFunction< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >, double, std::string, std::shared_ptr< tudat::system_models::VehicleSystems > >,
            //                              function_get_interpolator, flightpathangle, parameter, vehicleSystems );

            //std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >() > interpolator =
            //        std::bind( &evaluateTrivariateFunction< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >, double, std::string, std::shared_ptr< tudat::system_models::VehicleSystems > >,
            //                   function_choose_interpolator, flightpathangle, parameter, bodyMap.at( bodyWithProperty )->getVehicleSystems() );

            //std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >() > interpolator =
            // std::bind( &system_models::VehicleSystems::getGuidanceInterpolator, bodyMap.at( bodyWithProperty )->getVehicleSystems(), parameter );




            //! Retrieve function for flight-path angle.
            std::function< double( ) > firstInput = std::bind( &reference_frames::AerodynamicAngleCalculator::getAerodynamicAngle,
                                                               bodyMap.at( bodyWithProperty )->getFlightConditions( )->getAerodynamicAngleCalculator( ),
                                                               tudat::reference_frames::flight_path_angle );

            //! Retrieve function for parameter string ---> could this be turned into an 'enum'?
            std::string parameter = "Throttle Setting";
            std::function< std::string( ) > secondInput = std::bind( &bislip::variables::passGuidanceParameter, parameter );

            //! Retrieve function for vehicle systems.
            std::function< std::shared_ptr< tudat::system_models::VehicleSystems >( ) > thirdInput = std::bind( &simulation_setup::Body::getVehicleSystems, bodyMap.at( bodyWithProperty ) );
            ...
            std::function< double( ) > sixthInput =
                    std::bind( &system_models::VehicleSystems::getE_max, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
            //                   std::bind( &simulation_setup::Body::getE_max, bodyMap.at( bodyWithProperty ) );


            variableFunction = std::bind( &evaluateHexavariateFunction< double, double, std::string, std::shared_ptr< tudat::system_models::VehicleSystems >, double, double, double >,
                                          functionToEvaluate, firstInput, secondInput, thirdInput, fourthInput, fifthInput, sixthInput );
            break;
        }
        case thrust_elevation_angle:
        {
            if( std::dynamic_pointer_cast< aerodynamics::AtmosphericFlightConditions >(
                        bodyMap.at( bodyWithProperty )->getFlightConditions( ) )== nullptr )
            {
            ...
            // std::cout << "Thust Elevation Angle for dependent variable" << std::endl;




            /*
            std::function< double( const std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >, const double, const double, const double ) > functionToEvaluate =
                    std::bind( &bislip::variables::evaluateGuidanceInterpolator, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4);

            // Retrieve functions for thrust elevation angle.
            //   std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >() > interpolator =
            //         std::bind( &system_models::VehicleSystems::getThrustElevationAngleInterpolator, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
            std::function< std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > >() > interpolator;
            std::cout << "Thrust elevation angle for dependent variable" << std::endl;

            if (  bodyMap.at( bodyWithProperty )->getFlightConditions( )->getAerodynamicAngleCalculator( )->getAerodynamicAngle( tudat::reference_frames::flight_path_angle ) > 0 )
            {
                interpolator = std::bind( &system_models::VehicleSystems::getThrustElevationAngleInterpolator_Ascent, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
            }
            else
            {
                interpolator = std::bind( &system_models::VehicleSystems::getThrustElevationAngleInterpolator_Descent, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
            }
            ...
            variableFunction = std::bind( &evaluateTetravariateFunction< double, std::shared_ptr< tudat::interpolators::OneDimensionalInterpolator< double, double > > , double, double, double >,
                                          functionToEvaluate, interpolator, firstInput, secondInput, thirdInput );
            ...
            */
            ...
            //! Retrieve function for parameter string ---> could this be turned into an 'enum'?
            std::string parameter = "Thrust Elevation Angle";
            std::function< std::string( ) > secondInput = std::bind( &bislip::variables::passGuidanceParameter, parameter );
        ...
        case angular_distance_traveled:
        {
            ...
            std::function< double( ) > firstInput =
                    std::bind( &system_models::VehicleSystems::getInitialLat, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
            std::function< double( ) > secondInput =
                    std::bind( &system_models::VehicleSystems::getInitialLon, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
        ...
        case angular_distance_to_go:
        {
            ...
            std::function< double( ) > thirdInput =
                    std::bind( &system_models::VehicleSystems::getTargetLat, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
            std::function< double( ) > fourthInput =
                    std::bind( &system_models::VehicleSystems::getTargetLon, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
        ...
        case heat_rate_leading_edge:
        {
            ...
            std::function< double( ) > secondInput =
                    std::bind( &bislip::variables::computeFlatPlateHeatFlux, flightConditions, vehicleSystems );

            // Retrieve functions for wing sweep angle
            std::function< double( ) > thirdInput =
                    std::bind( &system_models::VehicleSystems::getWingSweepAngle, bodyMap.at( bodyWithProperty )->getVehicleSystems() );
