...
enum PropagationDependentVariables
{
    ...
    throttle_setting = 46,
    thrust_elevation_angle = 47,
    current_mass = 48,
    engine_status = 49,
    angular_distance_traveled = 50,
    angular_distance_to_go = 51,
    heading_to_target = 52,
    heading_error = 53,
    heat_rate_leading_edge = 54,
    body_fixed_thrust_vector = 55

    //    thrust_force_magnitude = 48
};
