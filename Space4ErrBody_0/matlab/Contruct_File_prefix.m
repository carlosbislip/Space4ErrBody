function [ Folder_Path_List,...
    ...
    fitnessMagnitudeAverages_File_Path_List_prefix,...
    ...
    alphaMachBounds_prefix,fitnessMagnitudeAverages_prefix,...
    pop_Location,...
    pop_prefix,...
    fit_Location,...
    fit_prefix)
...
fitnessMagnitudeAverages_File_Path_List_prefix = fullfile(Folder_Path_List,fitnessMagnitudeAverages_prefix);
