function [evolutions,prop_path,depvar_path,interp_Ascent_path,interp_Descent_path,DV_mapped_path,tof,v_i,gamma_i,chi_i,lat_f,lon_f,pop_path,...
...
[prop_path,depvar_path,interp_Ascent_path,interp_Descent_path,DV_mapped_path,tof,v_i,gamma_i,chi_i,lat_f,lon_f,pop_path,pop_i,fit_path,fit_i] = ...
    Contruct_File_Paths(...
    prop_Output_files,...
    n_prop_Output_files,...
    depvar_Output_files,...
