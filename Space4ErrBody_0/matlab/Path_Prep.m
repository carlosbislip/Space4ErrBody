function [evolutions,prop_path,depvar_path,interp_Ascent_path,interp_Descent_path,DV_mapped_Ascent_path,DV_mapped_Descent_path,headingErrorDeadbandBounds_path,tof,v_i,gamma_i,chi_i,lat_f,lon_f,pop_path,...
                pop_i,fit_path,fit_i,output] = Path_Prep(option,p,...
                prop_File_Path_List_prefix,depvar_File_Path_List_prefix,interp_Ascent_File_Path_List_prefix,interp_Decent_File_Path_List_prefix,DV_mapped_Ascent_File_Path_List_prefix,DV_mapped_Descent_File_Path_List_prefix,headingErrorDeadbandBounds_File_Path_List_prefix,...
...
[prop_path,depvar_path,interp_Ascent_path,interp_Descent_path,DV_mapped_Ascent_path,DV_mapped_Descent_path,headingErrorDeadbandBounds_path,tof,v_i,gamma_i,chi_i,lat_f,lon_f,pop_path,pop_i,fit_path,fit_i] = ...
    Contruct_File_Paths(...
    prop_Output_files,...
    n_prop_Output_files,...
    depvar_Output_files,...
