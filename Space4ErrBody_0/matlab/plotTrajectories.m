...
for p = 1:numel(compilation)
    ...
    plotearth('Maptype','bluemarble',...
        'NEOMap',...
        '/Users/bislip/Cloud Storage/OneDrive/School/TUDelft/Space Flight/Thesis/tudatBundle.git/tudatApplications/Space4ErrBody.git/Space4ErrBody_0/matlab/additionalfunctions/PlotEarth/PlotEarth/BlueMarble.png',...
